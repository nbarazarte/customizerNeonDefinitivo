          ...
          <div class="card-body" style="background-color: #D3D3D3">
            ...
            <div class="cc-selector">
              ...
              <figure class="figure">
                ...
                <input  type="radio" name="colores" value="celeste" id="celesteColor" onchange="deshabiltarBotonCart()">
                <label class="drinkcard-cc-colores celesteColor" for="celesteColor"></label>

                <figcaption class="figure-caption text-center" style="font-size: 8px; color: #000000; position: relative; top: -21px; left: 5px;">CELESTE</figcaption>
